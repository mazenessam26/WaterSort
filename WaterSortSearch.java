...
public class WaterSortSearch extends GenericSearch {
    ...
    public String solve(String initialState, String strategy, boolean visualize) {
        ...
        if (strategy.equals("BF")) {
            ...
            int heuristicOption = Integer.parseInt(strategy.substring(2));
 ...
 // Iterative Deepening Search (IDS)
    private String iterativeDeepeningSearch(String initialState, boolean visualize) {
    ...
    private String depthLimitedSearch(String initialState, int limit, boolean visualize, int nodesExpanded) {
        Stack<Node> frontier = new Stack<>();
        Set<String> explored = new HashSet<>();
 ...
 // Heuristic function with two different heuristics
    private int heuristic(Node node, int heuristicOption) {
    ...
    private String greedySearch(String initialState, boolean visualize, int heuristicOption) {
    ...
    private String aStarSearch(String initialState, boolean visualize, int heuristicOption) {
    ...
    private int totalCost(Node node, int heuristicOption) {
